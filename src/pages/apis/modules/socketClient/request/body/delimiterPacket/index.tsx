...
import DelimiterHeader from './columns/delimiterItem/header';
import DelimiterItem from './columns/delimiterItem';

type DataItem = DelimiterPacketDataItem & { is_empty_row: boolean };
type Props = {
  value: DelimiterPacketDataItem[];
  onChange: (newVal: DelimiterPacketDataItem[]) => void;
};
const DelimiterPacket: React.FC<Props> = (props) => {
  ...
  const columnsList = useMemo(() => {
    return [
      ...
      {
        title: <DelimiterHeader onChangeAll={handleChangeAll} />,
        dataIndex: 'delimiter',
        enableResize: true,
        width: 250,
        element: DelimiterItem,
      },
      {
        title: '描述',
...
export default DelimiterPacket;
