...
import { SocketIOEvent } from '#types/collection/websocket';
import { TABLE_COLUMNS, DEFAULT_DATA_ITEM } from './constants';
import useProjectInfo from '@hooks/useProjectInfo';

type Props = {
  value: Array<SocketIOEvent & { is_empty_row?: boolean }>;
  onChange: (newVal: Array<SocketIOEvent & { is_empty_row?: boolean }>) => void;
};
